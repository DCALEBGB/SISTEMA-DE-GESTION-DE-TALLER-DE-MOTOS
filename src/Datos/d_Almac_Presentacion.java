...
public class d_Almac_Presentacion {
    ...
    public d_Almac_Presentacion() {
    }

    public d_Almac_Presentacion(int id) {
        this.id = id;
    }

    public d_Almac_Presentacion(int id, String nombre, int fl_estado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public boolean equals(Object obj){
        ...
        if (obj != null) {
            ...
            return this.id == ((d_Almac_Presentacion) obj).id;
