 ...
 */
public class frm_Confi_local extends javax.swing.JFrame {
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Confi_local func = new l_Confi_local();
    ...
    void nuevo(){
        ...
        d_Confi_local dts = new d_Confi_local();
        l_Confi_local func = new l_Confi_local();
    ...
    String validar_nombre_existente(String nombre, Integer id_local){
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_local);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_local = table_registro.getValueAt(fila, 0).toString();
        
        d_Confi_local  r;
        
        l_Confi_local func = new l_Confi_local();
        
        r = func.llenar_campos(id_local);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_LOCAL");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_local.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_local.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Confi_local().setVisible(true);
            }
        });
    }
