...
import Logica.l_Confi_Tipo_Mano_Obra;
 ...
 */
public class frm_Confi_Tipo_Mano_Obra extends javax.swing.JFrame {
    ...
    public frm_Confi_Tipo_Mano_Obra() {
        initComponents();
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Confi_Tipo_Mano_Obra func = new l_Confi_Tipo_Mano_Obra();
    ...
    void nuevo(){
        ...
        d_Confi_Tipo_Mano_Obra dts = new d_Confi_Tipo_Mano_Obra();
        l_Confi_Tipo_Mano_Obra func = new l_Confi_Tipo_Mano_Obra();
    ...
    String validar_nombre_existente(String nombre, Integer id_mano_obra){
        
        String r = "";
        
       d_Confi_Tipo_Mano_Obra dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_mano_obra);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_mano_obra = table_registro.getValueAt(fila, 0).toString();
        
        d_Confi_Tipo_Mano_Obra  r;
        
        l_Confi_Tipo_Mano_Obra func = new l_Confi_Tipo_Mano_Obra();
        
        r = func.llenar_campos(id_mano_obra);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_MANO_OBRA");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_Tipo_Mano_Obra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_Tipo_Mano_Obra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Confi_Tipo_Mano_Obra().setVisible(true);
            }
        });
    }
