 ...
 */
public class frm_Almac_Tipo_Articulo extends javax.swing.JFrame {
    ...
    public frm_Almac_Tipo_Articulo() {
        initComponents();
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Almac_Tipo_Articulo func = new l_Almac_Tipo_Articulo();
    ...
    void nuevo(){
        ...
        d_Almac_Tipo_Articulo dts = new d_Almac_Tipo_Articulo();
        l_Almac_Tipo_Articulo func = new l_Almac_Tipo_Articulo();
    ...
    String validar_nombre_existente(String nombre, Integer id_articulo){
        
        String r = "";
        
        d_Almac_Tipo_Articulo dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_articulo);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        d_Almac_Tipo_Articulo  r;
        
        l_Almac_Tipo_Articulo func = new l_Almac_Tipo_Articulo();
        
        r = func.llenar_campos(id_articulo);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_ARTICULO");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Almac_Tipo_Articulo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Almac_Tipo_Articulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Almac_Tipo_Articulo().setVisible(true);
            }
        });
    }
