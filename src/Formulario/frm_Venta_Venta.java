 ...
 * @author PC
 */
public class frm_Venta_Venta extends javax.swing.JDialog {


    
    public frm_Venta_Venta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   void mostrar(){
    ...
    private void initComponents() {
        ...
        lbltitulo_venta.setText("REGISTRO DE VENTAS");
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        int id_venta = Integer.parseInt(table_registro.getValueAt(fila, 0).toString());
        
        frm_Venta_VentaDetalle form = new frm_Venta_VentaDetalle(null , true);
        
        form.lbltitulo_venta.setText("VENTA: " + table_registro.getValueAt(fila, 2).toString());
        
        form.mostrar_detalle(id_venta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Venta_Venta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_Venta_Venta dialog = new frm_Venta_Venta(new javax.swing.JFrame(), true);
