 ...
 * @author PC
 */
public class frm_Venta_VentaDetalle extends javax.swing.JDialog {


    
    public frm_Venta_VentaDetalle(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   void mostrar_detalle(int id_venta){
        
        try {
            
            DefaultTableModel modelo;
            l_Venta_Venta func = new l_Venta_Venta();
            modelo = func.mostrar_ventadetalle(id_venta);
    ...
    private void initComponents() {
        ...
        lbltitulo_venta.setText("DETALLE VENTA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Venta_VentaDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_Venta_VentaDetalle dialog = new frm_Venta_VentaDetalle(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JLabel lbltitulo_venta;
