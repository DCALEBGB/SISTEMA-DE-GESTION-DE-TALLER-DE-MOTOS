 ...
 */
public class frm_Almac_Almacen extends javax.swing.JFrame {
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Almac_Almacen func = new l_Almac_Almacen();
    ...
    void nuevo(){
        ...
        d_Almac_Almacen dts = new d_Almac_Almacen();
        l_Almac_Almacen func = new l_Almac_Almacen();
    ...
    String validar_nombre_existente(String nombre, Integer id_almacen){
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_almacen);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_ALMACEN");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Almac_Almacen.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Almac_Almacen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Almac_Almacen().setVisible(true);
            }
        });
    }
