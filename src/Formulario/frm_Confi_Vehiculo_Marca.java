...
import Logica.l_Confi_Vehiculo_Marca;
 ...
 */
public class frm_Confi_Vehiculo_Marca extends javax.swing.JFrame {
    ...
    public frm_Confi_Vehiculo_Marca() {
        initComponents();
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Confi_Vehiculo_Marca func = new l_Confi_Vehiculo_Marca();
    ...
    void nuevo(){
        ...
        d_Confi_Vehiculo_Marca dts = new d_Confi_Vehiculo_Marca();
        l_Confi_Vehiculo_Marca func = new l_Confi_Vehiculo_Marca();
    ...
    String validar_nombre_existente(String nombre, Integer id_vehiculo_marca){
        
        String r = "";
        
       d_Confi_Vehiculo_Marca dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_vehiculo_marca);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARCA DE VEHÍCULO");
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_VEHICULO_MARCA");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_Vehiculo_Marca.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_Vehiculo_Marca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Confi_Vehiculo_Marca().setVisible(true);
            }
        });
    }
