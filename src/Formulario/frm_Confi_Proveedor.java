 ...
 */
public class frm_Confi_Proveedor extends javax.swing.JFrame {
    ...
    void nuevo(){
        ...
        d_Confi_Proveedor dts = new d_Confi_Proveedor();
        l_Confi_Proveedor func = new l_Confi_Proveedor();
    ...
    String validar_numero_documento_existente(String numero_documento, Integer id_cliente){
        
        String r = "";
        
        d_Confi_Proveedor  dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_numero_documento_exitente(numero_documento, accion, id_cliente);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_cliente = table_registro.getValueAt(fila, 0).toString();
        
        d_Confi_Proveedor  r;
        
        l_Confi_Proveedor func = new l_Confi_Proveedor();
        
        r = func.llenar_campos(id_cliente);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_PROVEEDOR");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_Proveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Confi_Proveedor().setVisible(true);
            }
        });
    }
