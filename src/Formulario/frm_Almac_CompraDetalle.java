 ...
 * @author PC
 */
public class frm_Almac_CompraDetalle extends javax.swing.JDialog {


    
    public frm_Almac_CompraDetalle(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    void ajustes_jtable(){
        ...
        table_registro.getColumnModel().getColumn(1).setPreferredWidth(500);
        ...
        table_registro.getColumnModel().getColumn(3).setCellRenderer(rightRenderer);
        table_registro.getColumnModel().getColumn(4).setCellRenderer(rightRenderer);
   ...
   void mostrar_detalle(int id_compra){
        
        try {
            
            DefaultTableModel modelo;
            l_Almac_Compra func = new l_Almac_Compra();
            modelo = func.mostrar_compradetalle(id_compra);
    ...
    private void initComponents() {
        ...
        lbltitulo_compra = new javax.swing.JLabel();
        ...
        lbltitulo_compra.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        lbltitulo_compra.setForeground(new java.awt.Color(51, 51, 51));
        lbltitulo_compra.setText("DETALLE COMPRA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Almac_CompraDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_Almac_CompraDetalle dialog = new frm_Almac_CompraDetalle(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JLabel lbltitulo_compra;
