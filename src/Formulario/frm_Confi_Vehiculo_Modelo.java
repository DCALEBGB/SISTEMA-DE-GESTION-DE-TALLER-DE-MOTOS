...
import Logica.l_Confi_Vehiculo_Modelo;
 ...
 */
public class frm_Confi_Vehiculo_Modelo extends javax.swing.JFrame {
    ...
    public frm_Confi_Vehiculo_Modelo() {
        initComponents();
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Confi_Vehiculo_Modelo func = new l_Confi_Vehiculo_Modelo();
    ...
    void nuevo(){
        ...
        d_Confi_Vehiculo_Modelo dts = new d_Confi_Vehiculo_Modelo();
        l_Confi_Vehiculo_Modelo func = new l_Confi_Vehiculo_Modelo();
    ...
    String validar_nombre_existente(String nombre, Integer id_vehiculo_modelo){
        
        String r = "";
        
       d_Confi_Vehiculo_Modelo dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_vehiculo_modelo);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_vehiculo_modelo = table_registro.getValueAt(fila, 0).toString();
        
        d_Confi_Vehiculo_Modelo  r;
        
        l_Confi_Vehiculo_Modelo func = new l_Confi_Vehiculo_Modelo();
        
        r = func.llenar_campos(id_vehiculo_modelo);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_VEHICULO_MODELO");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_Vehiculo_Modelo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_Vehiculo_Modelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Confi_Vehiculo_Modelo().setVisible(true);
            }
        });
    }
