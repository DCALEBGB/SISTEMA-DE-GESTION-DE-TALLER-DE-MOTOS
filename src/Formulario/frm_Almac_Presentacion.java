 ...
 */
public class frm_Almac_Presentacion extends javax.swing.JFrame {
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Almac_Presentacion func = new l_Almac_Presentacion();
    ...
    void nuevo(){
        ...
        d_Almac_Presentacion dts = new d_Almac_Presentacion();
        l_Almac_Presentacion func = new l_Almac_Presentacion();
    ...
    String validar_nombre_existente(String nombre, Integer id_presentacion){
        
        String r = "";
        
        d_Almac_Presentacion  dc;
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_presentacion);
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_presentacion = table_registro.getValueAt(fila, 0).toString();
        
        d_Almac_Presentacion r;
        
        l_Almac_Presentacion func = new l_Almac_Presentacion();
        
        r = func.llenar_campos(id_presentacion);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_ALMACEN_PRESENTACION");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Almac_Presentacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Almac_Presentacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Almac_Presentacion().setVisible(true);
            }
        });
    }
