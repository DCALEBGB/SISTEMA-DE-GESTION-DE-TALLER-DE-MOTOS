 ...
 */
public class frm_Confi_Cliente extends javax.swing.JFrame {
    ...
    void nuevo(){
        ...
        d_Confi_Cliente dts = new d_Confi_Cliente();
        l_Confi_Cliente func = new l_Confi_Cliente();
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_CLIENTE");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Confi_Cliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Confi_Cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
