 ...
 */
public class frm_Almac_Marca extends javax.swing.JFrame {
    ...
    void mostrar(String buscar){
        ...
        try {
            ...
            l_Almac_Marca func = new l_Almac_Marca();
    ...
    void nuevo(){
        ...
        d_Almac_Marca dts = new d_Almac_Marca();
        l_Almac_Marca func = new l_Almac_Marca();
    ...
    String validar_nombre_existente(String nombre, Integer id_marca){
        ...
        if (accion.equals("nuevo")) {
            ...
            dc = func.validar_nombre_exitente(nombre, accion, id_marca);
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnexportar_excel, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(18, 18, 18)
    ...
    private void table_registroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_registroMousePressed
        ...
        String id_marca = table_registro.getValueAt(fila, 0).toString();
        
        d_Almac_Marca  r;
        
        l_Almac_Marca func = new l_Almac_Marca();
        
        r = func.llenar_campos(id_marca);
    ...
    private void btnexportar_excelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportar_excelActionPerformed
        ...
        try {
            ...
            func.tabletoexcel(table_registro, "REPORTE_MARCA");
            
            JOptionPane.showMessageDialog(rootPane, "Reporte generado con éxito");
            
            
        } catch (IOException ex) {
            Logger.getLogger(frm_Almac_Marca.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Almac_Marca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Almac_Marca().setVisible(true);
            }
        });
    }
