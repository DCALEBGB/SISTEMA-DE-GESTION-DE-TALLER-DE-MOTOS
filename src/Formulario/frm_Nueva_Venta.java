 ...
 * @author PC
 */
public class frm_Nueva_Venta extends javax.swing.JDialog {
    ...
    void select_cliente(int id){
        
        l_Confi_Cliente func = new l_Confi_Cliente();
        ArrayList<d_Confi_Cliente> array= func.select_cliente();
        
        cbocliente.removeAllItems();
        
        for(int x = 0; x < array.size(); x++){
            
            cbocliente.addItem(new d_Confi_Cliente(array.get(x).getId(), array.get(x).getNumero_documento(), array.get(x).getNombre(), array.get(x).getApellido_paterno(), array.get(x).getApellido_materno()));     
            
        }
 
        if (id != 0) {
            
            cbocliente.setSelectedItem(new d_Confi_Cliente(id));
    ...
    void get_articulo(String tipo_filtro, String valor){
        ...
        l_Venta_Venta func = new l_Venta_Venta();
    ...
    void insertar_venta(){
        ...
        d_Venta_Venta dts = new d_Venta_Venta();
        l_Venta_Venta func = new l_Venta_Venta();
        ...
        dts.setId_cliente(cbocliente.getItemAt(cbocliente.getSelectedIndex()).getId());
        dts.setId_comprobante(cbocomprobante.getItemAt(cbocomprobante.getSelectedIndex()).getId());

        
        if (func.insertar_venta(dts)) {
            
            
            for (int i = 0; i < this.table_detalle.getRowCount(); i++) {
                
                d_Venta_VentaDetalle dtvd = new d_Venta_VentaDetalle();
                l_Venta_Venta func_d = new l_Venta_Venta(); 
                ...
                func_d.insertar_venta_detalle(dtvd);
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1319, 665));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cliente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Consolas", 1, 14), new java.awt.Color(102, 102, 102))); // NOI18N

        cbocliente.setFont(new java.awt.Font("Consolas", 1, 12)); // NOI18N
        cbocliente.setPreferredSize(new java.awt.Dimension(28, 21));
        ...
        btnregistrar.setText("Guardar venta !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Nueva_Venta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_Nueva_Venta dialog = new frm_Nueva_Venta(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<Datos.d_Confi_Cliente> cbocliente;
